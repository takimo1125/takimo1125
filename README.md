...
## Skills（業務）
<img alt="my skills" src="https://skillicons.dev/icons?theme=dark&perline=7&i=html,css,js,vue,python,fastapi,,docker,cs,vb" />
<br>

## Skills(学習中)
<img alt="my skills" src="https://skillicons.dev/icons?theme=dark&perline=7&i=html,css,js,ts,vue,react,next,figma,python,fastapi,go,docker,terraform,aws" />
<br>
